      ...
      <div className="bg-[#7CD05F] w-[390px] h-[123px] flex items-center justify-between px-4">
        <div className="flex items-center">
          <div onClick={ProfilePage} className="mr-5">
            <Image src="/Vector2.svg" alt="กลับหน้าหลัก" width={15} height={4} />
          </div>
          <div>
            <b className="text-2xl text-white">จัดการโปรไฟล์</b>
          </div>
        </div>
        <div className="bg-[#6FC253] w-14 h-14 rounded-full flex items-center justify-center">
